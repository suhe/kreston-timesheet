...
class CI_Loader {
	...
	{	
		...
		$this->_ci_template_path = APPPATH.'templates/';
	...
	function template($path,$return = FALSE)
	{
		//return $this->_ci_load(array('_ci_template' => $template,'_ci_return' => $return));
		//APPPATH.'templates/'.$template.EXT;
		//return $this->_ci_load(array('_ci_path' => APPPATH.'templates/'.$path.'/index'.EXT, '_ci_return' => $return));
		return $this->_ci_load(array('_ci_path' => 'templates/'.$path.'/index'.EXT, '_ci_return' => $return));
	...
	function _ci_load($_ci_data)
	{
		...
		foreach (array('_ci_view','_ci_template', '_ci_vars', '_ci_path', '_ci_return') as $_ci_val)
		{
