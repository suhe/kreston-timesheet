<form class="cmxform" enctype="multipart/form-data" id="signupForm" method="POST" action="<?php echo base_url()?>group/hrd/update">
...
<fieldset>
      ...
      <p>
		...
		<p align="center">
            ...
            <a href="<?php echo base_url()?>group/hrd/index" class="submit">Back</a>
		</p>
	</fieldset>
</form>
