        ...
        <div id="navigation">
            ...
            <a target="_blank" class="button" href="<?php echo base_url();?>overtime/accounting/print_out/<?php echo $_SESSION['tr_code'];?>">Print Preview</a>
            <a class="button" href="<?php echo base_url();?>overtime/accounting/index">Back</a>
        </div>
