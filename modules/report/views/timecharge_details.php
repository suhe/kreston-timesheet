		...
		<?=form_open('report/user/timecharge_details_query','style="margin:0"')?>
		   <?=form_input(array('name' => 'query','value' => $this->session->userdata('timecharge_details.name'),'placeholder'=>'Search By Client Name','style'=>'padding:7px;widht:200px;border:1px solid #CCC'));?>
		   <?=form_dropdown('status',array(''=>'All','active'=>'Active','deactive'=>'Non Active'),!$this->session->userdata('timecharge.status')?'':$this->session->userdata('timecharge_details.status'),'style="padding:5px;border:1px solid #CCC"');?>
