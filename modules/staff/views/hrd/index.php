...
/*  */
        ...
        <div id="navigation">
			...
			<?php if($_SESSION['no']<>'20006'): ?>
			<a class="button" href="<?php echo base_url();?>staff/hrd/excel">Export Excel</a>
			<?php endif;?>
        </div>
            ...
            <?php foreach($records as $rec):?>
              ...
              <td>
               <?php if ($rec['status']=='active'):?>
                    <a href="<?php echo base_url();?>staff/hrd/status_deactive/<?php echo $rec['no'];?>">yes</a>
              <?php else: ?>
<a href="<?php echo base_url();?>staff/hrd/status_active/<?php echo $rec['no'];?>">No</a>                
               <?php endif; ?>
              </td> 
              <td><?php echo $rec['email'];?></td>
               ...
               <td><?php echo indo_tgl($rec['staff_date']);?></td> 
               <td>
