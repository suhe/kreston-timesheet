        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
          ...
          <?php if($rec['status_manager']=='process'): ?> 
            ...
            <tr>
               ...
               <td>
                    <a href="<?php echo base_url();?>overtime/admin/listing/<?php echo $rec['tr_code'];?>"><img src="<?php echo base_url();?>assets/images/view.gif" /></a>
                    <a href="<?php echo base_url();?>overtime/admin/print_out/<?php echo $rec['tr_code'];?>/" target="_blank"><img src="<?php echo base_url();?>assets/images/b_print.png" /></a>
               </td>
               </tr>
           <?php endif; ?>
            <?php endif; ?>   
