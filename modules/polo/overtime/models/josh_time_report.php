...
class Josh_time_report extends Model
{
    ...
    function selectPeriodeRecord()
    {
        ...
        $sql.=" JOIN josh_job ON josh_job.code=josh_details_tr.job_code ";
        $sql.=" Where "; 
	    $sql.=" josh_job.Manager='".$_SESSION['no']."'        OR ";
	    $sql.=" josh_job.Ass_Manager='".$_SESSION['no']."'        OR ";
	    $sql.=" josh_job.Senior_Manager='".$_SESSION['no']."' OR ";
	    $sql.=" josh_job.Senior='".$_SESSION['no']."'";
    ...
    function approvalManagerAll()
    {
       ...
       // $jumlah = count($this->input->post('date'));
		//$jumlah=count($_POST['date']);
