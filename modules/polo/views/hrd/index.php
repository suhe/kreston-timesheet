        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
          ...
          <tbody>
            ...
            <?php foreach($records as $rec):?>
               ...
               <td>         
                    <a href="<?php echo base_url();?>polo/hrd/print_out/<?php echo $rec['periode'];?>/" target="_blank"><img src="<?php echo base_url();?>assets/images/b_print.png" /></a>
					<a href="<?php echo base_url();?>polo/hrd/export_excel/<?php echo $rec['periode'];?>"><img src="<?php echo base_url();?>assets/images/excel.gif" /></a>
               </td>
               <!--<td>         
