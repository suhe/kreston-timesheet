        <div id="search">
		   ...
		   <?=form_input(array('name' => 'client_name','value' => $this->session->userdata('progress.client_name'),'placeholder'=>'Search By Client Name','style'=>'padding:7px;widht:200px;border:1px solid #CCC'));?>
		   <?=form_input(array('name' => 'staff_name','value' => $this->session->userdata('progress.staff_name'),'placeholder'=>'Search By Staff Name','style'=>'padding:7px;widht:200px;border:1px solid #CCC'));?>
