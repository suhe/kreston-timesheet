		...
		<?=form_open('salary/accounting/bulk_payroll','style="margin:0"')?>
		   ...
		   <input type="submit" value="Process" style="width:70px;padding:9px;margin:0;background:#64C1FF;cursor:pointer" />
		<?=form_close();?>   
        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
          <thead>
            <tr>
				...
				<th colspan="2">Periode 05</th>
				<th colspan="2">Periode 20</th>
