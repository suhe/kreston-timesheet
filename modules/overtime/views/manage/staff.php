...
/*  */
        ...
        <div id="navigation">
            <a class="button" href="<?php echo base_url();?>overtime/manage/index/">Back</a>
        </div>
        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
          ...
          <?php if(($rec['status_manager']=='process') || $rec['status_manager']=='approval' ): ?> 
            <?php
                $SQL="SELECT SUM(over_time) as total FROM josh_details_day_tr WHERE tr_code='$rec[tr_code]'";
                $Q=$this->db->query($SQL);
                $row=$Q->row_array();
                $total=$row['total']; 
            ?>
            ...
            <tr>
               ...
               <td>
                    ...
                    <?php endif;?>
					<a href="<?php echo base_url();?>overtime/manage/print_out/<?php echo $rec['tr_code'];?>/" target="_blank"><img src="<?php echo base_url();?>assets/images/b_print.png" /></a>
               </td>
               </tr>
               <?php endif; ?>
               <?php endif; ?>
