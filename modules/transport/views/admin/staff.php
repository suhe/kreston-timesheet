...
/*  */
        ...
        <div id="navigation">
            <a class="button" href="<?php echo base_url();?>time_report/admin/index/">Come Back</a>
        </div>
        ...
        <table cellpadding="1" cellspacing="1" id="resultTable">
          ...
          <?php foreach($records as $rec):?>
            ...
            <tr>
               ...
               <td>
                    <a href="<?php echo base_url();?>transport/admin/listing/<?php echo $rec['tr_code'];?>"><img src="<?php echo base_url();?>assets/images/view.gif" /></a>
