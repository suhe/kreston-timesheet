...
class User extends Controller
{
    ...
    function index(){
        $data['title']="Manage Reimbush Transport";
        $data['records']=$this->Josh_transport->selectRecords($_SESSION['no']); //database
        //web system data 
    ...
    function save(){
        $this->Josh_transport->saveTransport();
