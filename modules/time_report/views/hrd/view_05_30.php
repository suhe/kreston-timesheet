...
<div id="search">
        ...
        <div id="navigation">
            <a target="_blank" class="button" href="<?php echo base_url();?>time_report/hrd/print_out/<?php echo $_SESSION['tr_code'];?>">Print Preview</a>
            <a class="button" href="<?php echo base_url();?>time_report/hrd/periode/<?php echo $_SESSION['periode'];?>">Come Back</a>
        </div>
