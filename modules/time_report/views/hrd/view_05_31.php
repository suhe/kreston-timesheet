...
<?php echo $this->session->flashdata('message'); ?>
 ...
 <div class="mainpage2">
     ...
     <?php
                ...
                <div class="timePro">
                    <div class="time">
                           ...
                           <?php while($rec2=mysql_fetch_array($exe)){ ?>     
                            ...
                            <div class="cola11 <?php if(($rec2['name']=="Sunday") || ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mn as $day): ?> <?php  if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php  } ?><?php endforeach;?>"> <?php if(day($rec2['date'])== '31') { if($rec2['over_time_app'] < 1) { echo $k=$rec2['time'] + $rec2['over_time']; $a31=$a31+$k; $o31=$o31 + $rec2['over_time'];} else {echo $k=$rec2['time'] + $rec2['over_time_app'];$a31=$a31+$k; $o31=$o31 + $rec2['over_time_app'];}  } ?></div>
        ...
        <div class="content">
                ...
                <div class="timePro">
                    <div class="time">
                           ...
                           <?php $sql="SELECT DAYNAME(date) as name,date,time,over_time,over_time_app FROM josh_details_day_tr WHERE MONTH(date)='$mn' AND code='$rec[day_code]' order by date ASC "; ?>
                           <?php $exe=mysql_query($sql);?>
                           <?php while($rec2=mysql_fetch_array($exe)){ ?>
                            ...
                            <div class="cola11 <?php if(($rec2['name']=="Sunday") || ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mn as $day): ?> <?php  if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php  } ?><?php endforeach;?>"> <?php if(day($rec2['date'])== '31') { if($rec2['over_time_app'] < 1) { echo $kk=$rec2['time'] + $rec2['over_time']; $b31=$b31+$kk;  $ov31=$ov31+$rec2['over_time']; } else {echo $kk=$rec2['time'] + $rec2['over_time_app'];$b31=$b31+$kk; $ov31=$ov31+$rec2['over_time_app'];}  } ?></div>
                            <?php } ?>
        ...
        <?php if ( ($_SESSION['level']== 'HRD') OR ($_SESSION['level'] == 'HRD') ) : ?>
        <div class="content">
                <div class="namePro"><?php echo $rec['job_name']; ?></div>
                <div class="codePro"><?php echo $rec['job_code']; ?></div>
                <div class="timePro">
                    <div class="time">
                            ...
                            <?php 
                               $sql="SELECT DAYNAME(date) as name,date,time,over_time,over_time,over_time_app FROM josh_details_day_tr WHERE MONTH(date)='$mn' AND code='$rec[day_code]' AND type_job='nch' order by date ASC ";
                               $Q=$this->db->query($sql);
                               foreach ($Q->result_array() as $rec2) {
                                        //$rec=$row; }  
                            ...
                            <div class="cola11 <?php if(($rec2['name']=="Sunday") || ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mn as $day): ?> <?php  if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php  } ?><?php endforeach;?>"> <?php if(day($rec2['date'])== '31') { if($rec2['over_time_app'] < 1) { echo $kkk=$rec2['time'] + $rec2['over_time']; $c31=$c31+$kkk;} else {echo $kkk=$rec2['time'] + $rec2['over_time_app'];$c31=$c31+$kkk;}  } ?></div>
                ...
                <div class="total">
                    ...
                    <?php $cccbbbaaa= $cccbbbaaa+$aaabbbccc ?> 
                </div>
                ...
                <div class="charge">
                    ...
                    <!-- AM and Senior -->
                    <?php // foreach($group as $row): ?>
                      <?php  if( ('HRD' == $_SESSION['level']) OR ('AM' == $_SESSION['level']) OR  ('S2' == $_SESSION['level']) OR ('S1' == $_SESSION['level']) ):  ?>
                           <?php if($rec['staff_approval']=="yes") :?>
                                 <select name="approval" id="approval" onchange='this.form1.submit()' class="left"  >
                                 <option value="yes">yes</option>
                                 <option value="no">no</option>
        ...
        <div class="content contol hour">
                ...
                <div class="charge"><b class="b"></div>
                <div class="clear"></div>
        ...
        <div class="content contol hour">
                <div class="namePro"></div>
                <div class="codePro">NORMAL HOURS</div>
                <div class="timePro">
                    <div class="time"> 
