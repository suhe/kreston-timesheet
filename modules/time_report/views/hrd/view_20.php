       ...
       <?php
        ...
        <div class="content">
                ...
                <div class="charge">
                    ...
                    <!-- AM and Senior -->
                    <?php // foreach($group as $row): ?>
                      <?php  if( ('HRD' == $_SESSION['level']) OR  ('HRD' == $_SESSION['level']) ):  ?>
                           <?php if($rec['staff_approval']=="yes") :?>
                                 <select name="approval" id="approval" onchange='this.form1.submit()' class="left"  >
                                 <option value="yes">yes</option>
                                 <option value="no">no</option>
                    ...
                    <!-- Partner AND Manager  -->
                    <?php // foreach($group as $row): ?>
                    <?php  if(('HRD' == $_SESSION['level']) OR ('HRD' == $_SESSION['level']) OR ('HRD' == $_SESSION['level']) ):  ?>
                        <?php if($rec['staff_approval2']=="yes") : ?>
                            <select name="approval2" id="approval2" onchange='this.form1.submit()' class="left"  >
                                <option value="yes">yes</option>
                                <option value="no">no</option>
                    ...
                    <!-- Partner AND Manager  -->
                    <?php // foreach($group as $row): ?>
                    <?php if(('HRD' == $_SESSION['level']) OR ('HRD' == $_SESSION['level']) OR ( 'P' == $_SESSION['level']) ):  ?>
                    <?php if($rec['staff_approval2']=="no") : ?>     
                        <select name="approval2" id="approval2" onchange='this.form1.submit()' class="left"  >
                        <option value="no">no</option>
                        <option value="yes">yes</option>
