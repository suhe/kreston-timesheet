<!-- CSS File -->
<link  rel="stylesheet" href="<?php echo base_url();?>assets/css/tr/style_30.css"  type="text/css"/>
<!-- End OF CSS File -->
        ...
        <div class="content">
                ...
                <div class="timePro">
                    <div class="time">
                       ...
                       <?php $exe=mysql_query($sql);?>
                       <?php while($rec2=mysql_fetch_array($exe)){ ?>
                        <div class="cola11 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach;?>"><?php if(day($rec2['date'])== '01') { echo $rec2['time']; } ?></div>
                        <div class="cola12 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach;?>"><?php if(day($rec2['date'])== '02') { echo $rec2['time']; } ?></div>
                        <div class="cola13 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach;?>"><?php if(day($rec2['date'])== '03') { echo $rec2['time']; } ?></div>
                        <div class="cola14 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach;?>"><?php if(day($rec2['date'])== '04') { echo $rec2['time']; } ?></div>
                        <div class="cola15 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach;?>"><?php if(day($rec2['date'])== '05') { echo $rec2['time']; } ?></div>
                        <?php //$total_a=$a21+$a22+$a23+$a24+$a25+$a26+$a27+$a28+$a29+$a30+$a1+$a2+$a3+$a4+$a5;?>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="content">
                ...
                <div class="timePro">
                    <div class="time">
                       ...
                       <?php $sql="SELECT DAYNAME(date) as name,date,time FROM josh_details_day_tr WHERE MONTH(date)='$mn' AND code='$rec[day_code]' AND type_job='cho' order by date ASC "; ?>
                       <?php $exe=mysql_query($sql);?>
                       <?php while($rec2=mysql_fetch_array($exe)){ ?>
                ...
                <div class="timePro">
                    <div class="time">
                       ...
                       <?php while($rec2=mysql_fetch_array($exe)){ ?>
                        ...
                        <div class="cola14 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach; ?>"><?php if(day($rec2['date'])== '04') { echo $rec2['time']; } ?></div>
                        <div class="cola15 <?php if(($rec2['name']=="Sunday")|| ($rec2['name']=="Saturday")) {?>red<?php } ?><?php foreach($holiday_mm as $day): ?><?php if (day($day['date_h'])== day($rec2['date'])) { ?>blue<?php } ?><?php endforeach; ?>"><?php if(day($rec2['date'])== '05') { echo $rec2['time'];} ?></div>
                        <?php //$total_c=$c21+$c22+$c23+$c24+$c25+$c26+$c27+$c28+$c29+$c30+$c1+$c2+$c3+$c4+$c5;?>
                ...
                <div class="timePro">
                    <div class="time">
                      ...
                      <div class="cola3">
                        ...
                        <div class="cola11"><?php echo $totA1; ?><?php //if ($tot1 > 8) { echo $totA1=$tot1-8; } else { echo '-';}?></div>
                        <div class="cola12"><?php echo $totA2; ?><?php //if ($tot2 > 8) { echo $totA2=$tot2-8; } else { echo '-';};?></div>
                        <div class="cola13"><?php echo $totA3; ?><?php //if ($tot3 > 8) { echo $totA3=$tot3-8; } else { echo '-';};?></div>
                        <div class="cola14"><?php echo $totA4; ?><?php //if ($tot4 > 8) { echo $totA4=$tot4-8; } else { echo '-';};?></div>
                        <div class="cola15"><?php echo $totA5; ?><?php //if ($tot5 > 8) { echo $totA5=$tot5-8; } else { echo '-';};?></div>
