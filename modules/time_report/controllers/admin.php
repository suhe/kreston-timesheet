...
class Admin extends Controller
{
    function Admin()
    {
        parent::Controller();
        session_start();
         if ( ($_SESSION['level']=='ADM') OR ($_SESSION['level']=='SM') )
             {
    ...
    function index()
    {
        ...
        $data['title']="Manage Time Report For Admin";
        //database
    ...
    function periode($id)
    {
        ...
        $_SESSION['periode']=$id;
         //title 
        $data['title']="Manage Auditor Report For Administrator";
        //database
        $data['recordprocess']=$this->Josh_time_report->selectAdminPerPeriodeRecordPro($id);
        $data['recordapprov']=$this->Josh_time_report->selectAdminPerPeriodeRecordApprov($id);
        //web system data 
        $data['module']='time_report';
    ...
    function status_manager($id)
    {
		...
		redirect('time_report/admin/periode/'.$_SESSION['periode'],301);
    }
	...
	{ 
        ...
        redirect('time_report/admin/view/'.$_SESSION['tr_code'],301); 
