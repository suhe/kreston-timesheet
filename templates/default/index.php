...
<body>
	...
	<div class="menu_container">
		...
		<ul>
		  ...
		  <?php if(($_SESSION['level']=='HRD') || ($_SESSION['level']=='P') ){ ?>
		  ...
		  <!--<li><a href="<?=base_url()?>salary/accounting/basic">Salary</a></li>-->
		  <li><a href="<?=base_url()?>holiday/hrd/index">Holiday</a></li>
		  <?php } ?>
		  <?php //if(($_SESSION['level']=='HRD') || ($_SESSION['level']=='M') ){ ?>
		  <!--<li><a href="<?=base_url()?>job_desc/user/outstanding">Job Project</a></li>-->
		  <?php //} ?>
		  ...
		  <li><a href="<?=base_url()?>/report/user/index">Report</a></li>
		  <?php if($_SESSION['level']=='HRD'){ ?>
		  <li><a href="<?=base_url()?>/salary/accounting/payroll">Payroll</a></li>
		   <?php } ?>
