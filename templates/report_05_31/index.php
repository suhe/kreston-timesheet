        ...
        <div class="content">
                ...
                <div class="timePro">
                    <div class="time">
                            ...
                            <?php $sql="SELECT DAYNAME(date) as name,date,time,over_time,over_time,over_time_app FROM josh_details_day_tr WHERE MONTH(date)='$mn' AND code='$rec[day_code]' AND type_job='nch' order by date ASC "; ?>
                            <?php $exe=mysql_query($sql);?>
                            <?php while($rec2=mysql_fetch_array($exe)){ ?>
