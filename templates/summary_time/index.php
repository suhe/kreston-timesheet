...
<body>
   ...
   <?php
        ...
        $this->db->where('jht.periode >=',$this->input->post('year').'-'.$this->input->post('month').'-'.$this->input->post('day'));
        $this->db->where('jht.periode <=',$this->input->post('year2').'-'.$this->input->post('month2').'-'.$this->input->post('day2'));
