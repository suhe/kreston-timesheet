...
<body>
    <div id="container">
        ...
        <div class="menu">
                ...
                <div class="charge">Aproval(AM/S)</div>
                <div class="charge2">Aproval(M/P)</div>
                <div class="clear"></div>
        </div>
       ...
       <?php
        ...
        <div class="content contol">
                ...
                <div class="total" ><?php echo $total_a=$a21+$a22+$a23+$a24+$a25+$a26+$a27+$a28+$a1+$a2+$a3+$a4+$a5;?></div>
                <div class="work"></div>
       ...
       <?php
        ...
        <div class="content">
                ...
                <div class="total">
                    <?php $aabbcc=$aa + $bb + $cc + $dd + $ee + $ff + $gg + $hh  + $ll + $mmx + $nn + $oo + $pp; ?>
					<?php echo $aabbcc;  ?>
                </div>
        ...
        <div class="content contol">
                ...
                <div class="total"><?php echo $total_b=$b21+$b22+$b23+$b24+$b25+$b26+$b27+$b28+$b1+$b2+$b3+$b4+$b5;?></div>
                <div class="work"></div>
                <div class="transp">-</div>
                <div class="charge">-</div>
                <div class="charge"></div>
       ...
       <?php
        ...
        <div class="content">
                ...
                <div class="total">
                    <?php echo $aaabbbccc=$aaa + $bbb + $ccc + $ddd + $eee + $fff + $ggg + $hhh   + $lll + $mmm + $nnn + $ooo + $ppp; ?>
        ...
        <div class="content contol">
                ...
                <div class="total"><?php echo $total_c=$c21+$c22+$c23+$c24+$c25+$c26+$c27+$c28+$c1+$c2+$c3+$c4+$c5;?></div>
                <div class="work"></div>
                <div class="transp">-</div>
                <div class="charge">-</div>
                <div class="charge"></div>
        ...
        <div class="content contol hour">
                ...
                <div class="total">
                <?php $tot=$tot21+$tot22+$tot23+$tot24+$tot25+$tot26+$tot27+$tot28+$tot1+$tot2+$tot3+$tot4+$tot5;?>
                <?php //$tot=$tot21; ?>
                <?php echo $tot;?>
                </div>
        ...
        <div class="content contol hour">
                ...
                <div class="total"><?php echo $totA21+$totA22+$totA23+$totA24+$totA25+$totA26+$totA27+$totA28+$totA1+$totA2+$totA3+$totA4+$totA5;?></div>
                <div class="work"></div>
                <div class="transp">-</div>
                <div class="charge">-</div>
                <div class="charge">-</div>
		...
		<div class="content contol hour">
                ...
                <div class="total"><?php echo $hour=$ato21+$ato22+$ato23+$ato24+$ato25+$ato26+$ato27+$ato28+$ato1+$ato2+$ato3+$ato4+$ato5;?></div>
                <div class="work"></div>
                <div class="transp">-</div>
                <div class="charge">-</div>
                <div class="charge"> </div>
        ...
        <div id="keterangan">
            <div class="chargeb">
                ...
                <div class="ch1">
                    <div class="coder">NC1001</div><div class="namer">ANNUAL LEAVE</div>
                    <div class="clear"></div>
                    <div class="coder">NC1002</div><div class="namer">SICK LEAVE</div>
                    <div class="clear"></div>
                    <div class="coder">NC1003</div><div class="namer">PERSONAL LEAVE</div>
                    <div class="clear"></div>
                    <div class="coder">NC1004</div><div class="namer">TRAINING</div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="ch1">
                    ...
                    <div class="clear"></div>
                    <div class="coder">NC1006</div><div class="namer">PROPOSAL</div>
                    <div class="clear"></div>
